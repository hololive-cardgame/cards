...
const customRomajiMap = {
  ...
  "メルフィッサ": ["merufisa","melfissa"],
  "アーニャ・メルフィッサ": ["anyamelfissa","anyamerufisa","阿妮婭梅爾菲莎"],
  ...
  "カエラ": "kaela",
  "コヴァルスキア": ["kovarusukia","Kovalskia"],
  "カエラ・コヴァルスキア": ["kaerakovarusukia","kaelakovalskia","卡埃拉科瓦爾斯基亞"],
  "こぼ・かなえる": "可波卡娜埃露",
  // Myth
  "森": "mori",
  "カリオペ": "calliope",
  ...
  // Advent
  "ノヴェラ": ["novera","novella"],
  "シオリ・ノヴェラ": ["shiorinovera","shiorinovella","詩織諾薇拉"],
  "古石": "koseki",
  "ビジュー": "bijou",
  "古石ビジュー": ["kosekibiju","kosekibijou","古石碧珠"],
  "レイヴンクロフト": "ravencroft",
  ...
  "ローズ": ["rozu","rose"],
  "ブラッドフレイム": "bloodflame",
  "エリザベス・ローズ・ブラッドフレイム": ["elizabethrosebloodflame","伊麗莎白露絲布拉德弗雷姆"],
  "ジジ": "gigi",
  "ジジ・ムリン": ["gigimurin","琪琪沐林"],
  "セシリア": "cecilia",
  "イマーグリーン": "immergreen",
  "セシリア・イマーグリーン": ["seshiriaimagurin","ceciliaimmergreen","塞西莉亞伊默格林"],
  "ラオーラ": "raora",
  "パンテーラ": ["pantera","panthera"],
  "ラオーラ・パンテーラ": ["raorapantera","raorapanthera","拉歐拉潘特拉"],
  // 事務所
  "ホロライブ": "hololive",
  "インドネシア": ["indonesia","id"],
  // 職員
